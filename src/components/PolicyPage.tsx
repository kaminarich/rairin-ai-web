      ...
      <main className="legal-page">
        <div className="shell legal-shell">
          ...
          <article className="panel legal-card" id="terms">
            ...
            <p><T en="KAMINARICH sells RaiRin-AI, a digital Magisk/KernelSU module license for one rooted Android device. One qualifying payment buys one permanent license bound to the device serial submitted for activation. No physical product is shipped." id="KAMINARICH menjual RaiRin-AI, lisensi modul digital Magisk/KernelSU untuk satu perangkat Android yang sudah di-root. Satu pembayaran yang memenuhi syarat membeli satu lisensi permanen yang terikat pada serial perangkat untuk aktivasi. Tidak ada produk fisik yang dikirim." /></p>
            <h3><T en="2. Ordering and payment" id="2. Pemesanan dan pembayaran" /></h3>
            <p><T en="Website prices use Indonesian Rupiah (IDR). While direct Midtrans QRIS is unavailable, QRIS uses the Hotelmurah GoPay top-up page. Complete payment before the QR expiry shown by Hotelmurah and retain the receipt. Orders are validated manually through Telegram." id="Harga website menggunakan Rupiah Indonesia (IDR). Selama QRIS langsung Midtrans belum tersedia, QRIS menggunakan halaman top up GoPay Hotelmurah. Selesaikan pembayaran sebelum waktu kedaluwarsa QR yang ditampilkan Hotelmurah dan simpan bukti pembayaran. Pesanan divalidasi manual melalui Telegram." /></p>
            <h3><T en="3. Delivery and activation" id="3. Pengiriman dan aktivasi" /></h3>
            <p><T en="Send payment proof and the device serial to @kaminarich. Activation is handled manually after payment validation. Contact support if activation has not arrived within 24 hours after sending complete proof." id="Kirim bukti pembayaran dan serial perangkat ke @kaminarich. Aktivasi diproses manual setelah validasi pembayaran. Hubungi dukungan jika aktivasi belum diterima dalam 24 jam setelah mengirim bukti lengkap." /></p>
          ...
          <article className="panel legal-card" id="refund">
            ...
            <p><T en="Duplicate or unmatched payments are payment errors, not refund requests. Contact @kaminarich with complete payment proof for reconciliation. Do not pay an expired QRIS or create repeated payments." id="Pembayaran ganda atau tidak cocok merupakan kesalahan pembayaran, bukan permintaan pengembalian dana. Hubungi @kaminarich dengan bukti pembayaran lengkap untuk rekonsiliasi. Jangan membayar QRIS kedaluwarsa atau membuat pembayaran berulang." /></p>
          </article>

          <article className="panel legal-card" id="privacy">
            <h2><T en="Privacy Policy" id="Kebijakan Privasi" /></h2>
            <p><T en="We collect device serials, payment proof, transaction details, and support messages needed to issue and maintain the license. Hotelmurah processes temporary QRIS top-up data under its own privacy policy. Telegram processes messages you send through its service." id="Kami mengumpulkan serial perangkat, bukti pembayaran, detail transaksi, serta pesan dukungan yang diperlukan untuk menerbitkan dan memelihara lisensi. Hotelmurah memproses data top up QRIS sementara berdasarkan kebijakan privasinya. Telegram memproses pesan yang Anda kirim melalui layanannya." /></p>
